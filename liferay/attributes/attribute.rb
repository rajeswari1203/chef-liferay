...
default['java']['java_home']= "#{node['liferay']['install_location']}/jdk1.8.0_191"
default['java']['jre_home']= "#{node['java']['java_home']}/jre"
default['home']['bashprofile']= "/home/weloadm/.bash_profile"
